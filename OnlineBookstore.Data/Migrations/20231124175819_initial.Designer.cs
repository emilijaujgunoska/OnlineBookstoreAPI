...
namespace OnlineBookstore.Data.Migrations
{
    ...
    [Migration("20231124175819_initial")]
            ...
            modelBuilder.Entity("OnlineBookstore.Entities.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UserId = "13b31a26-1cb3-4f45-ae98-f07286945597",
            ...
            modelBuilder.Entity("OnlineBookstore.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("13b31a26-1cb3-4f45-ae98-f07286945597"),
                            Address = "/",
                            City = "Skopje",
                            Country = "Macedonia",
                            ...
                            IsAdmin = true,
                            PasswordHash = new byte[] { 173, 50, 112, 130, 89, 70, 37, 95, 231, 104, 73, 215, 156, 188, 158, 173, 238, 126, 15, 177, 246, 92, 32, 247, 81, 5, 167, 205, 82, 193, 67, 171, 17, 52, 74, 170, 135, 164, 213, 19, 7, 234, 163, 86, 113, 132, 33, 161, 133, 201, 40, 139, 168, 103, 232, 188, 115, 206, 25, 62, 220, 210, 200, 254 },
                            PasswordSalt = new byte[] { 120, 181, 229, 147, 16, 69, 54, 62, 126, 129, 247, 156, 164, 205, 70, 103, 181, 182, 145, 5, 242, 41, 58, 26, 189, 62, 45, 178, 75, 219, 209, 127, 50, 128, 110, 161, 3, 225, 151, 155, 48, 244, 92, 134, 74, 188, 82, 86, 28, 99, 158, 112, 36, 178, 218, 156, 4, 252, 62, 30, 253, 219, 227, 99, 72, 64, 63, 24, 218, 216, 184, 171, 119, 206, 34, 99, 6, 226, 169, 212, 125, 250, 33, 19, 222, 171, 86, 238, 217, 144, 204, 189, 143, 185, 153, 120, 84, 144, 59, 253, 14, 22, 96, 123, 92, 121, 149, 227, 165, 96, 55, 241, 39, 87, 216, 16, 119, 239, 15, 255, 67, 114, 98, 191, 128, 100, 139, 99 },
                            Phone = "1234567890",
                            UserCreated = new DateTime(2023, 11, 24, 18, 58, 19, 414, DateTimeKind.Local).AddTicks(7148),
