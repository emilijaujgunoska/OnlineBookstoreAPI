        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortDescription = table.Column<string>(type: "nvarchar(1100)", maxLength: 1100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookCategory = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    BookType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    BookDimensions = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    BookWeight = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 5, false, "Leo Tolstoy", "Count Lev Nikolayevich Tolstoy (9 September [O.S. 28 August] 1828 – 20 November [O.S. 7 November] 1910), usually referred to in English as Leo Tolstoy, was a Russian writer who is regarded as one of the greatest authors of all time. He received multiple nominations for the Nobel Prize in Literature every year from 1902 to 1906, and nominations for Nobel Peace Prize in 1901, 1902 and 1910, and the fact that he never won is a major Nobel prize controversy" },
                    ...
                    { 9, true, "Nicholas Sparks", "Nicholas Charles Sparks (born December 31, 1965) is an American romance novelist and screenwriter. He has published twenty novels and two non-fiction books. Several of his novels have become international bestsellers, and eleven of his romantic-drama novels have been adapted to film all with multimillion-dollar box office grosses.His novels feature stories of tragic love with happy endings." },
                    { 10, true, "Dan Brown", "Daniel Gerhard Brown (born June 22, 1964) is an American author best known for his thriller novels, including the Robert Langdon novels Angels & Demons (2000), The Da Vinci Code (2003), The Lost Symbol (2009), Inferno (2013) and Origin (2017). His novels are treasure hunts that usually take place over a period of 24 hours.[2] They feature recurring themes of cryptography, art, and conspiracy theories. His books have been translated into 57 languages and, as of 2012, have sold over 200 million copies. Three of them, Angels & Demons, The Da Vinci Code, and Inferno, have been adapted into films." }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("13b31a26-1cb3-4f45-ae98-f07286945597"), "/", "Skopje", "Macedonia", "*** Admin User***", "smx.est@smx.com", true, new byte[] { 173, 50, 112, 130, 89, 70, 37, 95, 231, 104, 73, 215, 156, 188, 158, 173, 238, 126, 15, 177, 246, 92, 32, 247, 81, 5, 167, 205, 82, 193, 67, 171, 17, 52, 74, 170, 135, 164, 213, 19, 7, 234, 163, 86, 113, 132, 33, 161, 133, 201, 40, 139, 168, 103, 232, 188, 115, 206, 25, 62, 220, 210, 200, 254 }, new byte[] { 120, 181, 229, 147, 16, 69, 54, 62, 126, 129, 247, 156, 164, 205, 70, 103, 181, 182, 145, 5, 242, 41, 58, 26, 189, 62, 45, 178, 75, 219, 209, 127, 50, 128, 110, 161, 3, 225, 151, 155, 48, 244, 92, 134, 74, 188, 82, 86, 28, 99, 158, 112, 36, 178, 218, 156, 4, 252, 62, 30, 253, 219, 227, 99, 72, 64, 63, 24, 218, 216, 184, 171, 119, 206, 34, 99, 6, 226, 169, 212, 125, 250, 33, 19, 222, 171, 86, 238, 217, 144, 204, 189, 143, 185, 153, 120, 84, 144, 59, 253, 14, 22, 96, 123, 92, 121, 149, 227, 165, 96, 55, 241, 39, 87, 216, 16, 119, 239, 15, 255, 67, 114, 98, 191, 128, 100, 139, 99 }, "1234567890", new DateTime(2023, 11, 24, 18, 58, 19, 414, DateTimeKind.Local).AddTicks(7148), "onlineBookstoreUsername" });
